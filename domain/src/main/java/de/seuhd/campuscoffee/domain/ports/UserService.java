...
public interface UserService {
    ...
    /**
     * Retrieves all user entities from the data store and returns them as domain
     * objects.
     *
    ...
    /**
     * Retrieves a single user entity by its unique identifier and returns it as a
     * domain object.
     *
    ...
    /**
     * Retrieves a single user entity by its unique login name and returns it as a
     * domain object.
     *
     ...
     * @return the persisted user entity with updated timestamps and ID as a domain
     *         object; never null
