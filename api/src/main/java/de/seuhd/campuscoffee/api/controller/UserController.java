...
public class UserController {
    ...
    @Operation(summary = "Get User by ID.", responses = {
            ...
            @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)), description = "No User with the provided ID could be found.")
    })
    @GetMapping("/{id}")
    ...
    @Operation(summary = "Get User by name.", responses = {
            ...
            @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)), description = "No User with the provided name could be found.")
    })
    @GetMapping("/filter")
    ...
    @Operation(summary = "Create a new User.", responses = {
            @ApiResponse(responseCode = "201", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserDto.class)), description = "The new User as a JSON object."),
            @ApiResponse(responseCode = "400", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)), description = "Validation failed")
    })
    @PostMapping("")
    ...
    @Operation(summary = "Update an existing User by ID.", responses = {
    ...
    @Operation(summary = "Delete a User by ID.", responses = {
            @ApiResponse(responseCode = "204", description = "The User was successfully deleted."),
            @ApiResponse(responseCode = "404", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ErrorResponse.class)), description = "No User with the provided ID could be found.")
    })
    @DeleteMapping("/{id}")
